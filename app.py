...
app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:///flask_social.db"
db = SQLAlchemy(app)
...
def init_db():
    ...
    user_dict = {
        ...
        "user0" : DBUser(username="user0", email="user0@example.com", password=bcrypt.hashpw(b"password", bcrypt.gensalt()))}
